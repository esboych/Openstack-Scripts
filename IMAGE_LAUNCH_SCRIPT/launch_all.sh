...
#launch 1st instance
nova boot --flavor net.1-2Gb-32Gb --image trusty-server-cloudimg-amd64-disk1 --key-name id_rsa-key --security-groups default --poll --nic net-id=$net_id  --availability-zone nova:$node1 Instance-nd1
#floating ip
